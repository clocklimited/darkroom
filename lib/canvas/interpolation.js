/**
 *  Pixel Interpolation
 *  http://jsperf.com/pixel-interpolation/2/edit
 *
 */

module.exports = function (canvas, context, width, height) {
  ...
  self.nearestUnrolled = nearest_unrolled
  ...
  self.bilinearOptimized = bilinear_optimized
  ...
  self.bilinearUnrolled = bilinear_unrolled
  ...
  self.bicubic_value = bicubic_value
  ...
  self.bicubic_optimized = bicubic_optimized
  ...
  self.bicubic_unrolled = bicubic_unrolled
