...
function getGifsicleContext (cb) {
  ...
  if (this.mode === 'cover') {
    return getGifsicleCoverResize.call(this, params, originalBuffer, cb)
...
function getGifsicleCoverResize(params, originalBuffer, cb) {
  ...
  var input = createGifsicle(params.concat('--resize-touch', dimens))
