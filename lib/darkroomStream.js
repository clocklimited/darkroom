...
DarkroomStream.prototype.execManifold = function () {
  console.error('execManifold has not been implemented.')
}

DarkroomStream.prototype.exec = function () {
  console.error('exec has not been implemented.')
}
