...
console.log(111, sharp.concurrency())
console.log(222, sharp.concurrency(process.env.NF_CPU_RESOURCES))
console.log(333, sharp.concurrency())
console.log(444, sharp.concurrency())
console.log(555, process.env.UV_THREADPOOL_SIZE)
class Crop extends DarkroomStream {
  constructor(options) {
    super(options)
    if (options.concurrency) sharp.concurrency(options.concurrency)
